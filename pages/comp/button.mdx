...
``` --- ### With icons
<div className="flex gap-2">
    <Button leftIcon={<HiMenuAlt2 className="mr-1 h-4 w-4" />}>Button</Button>
    <Button rightIcon={<HiMenuAlt2 className="ml-1 h-4 w-4" />}>Button</Button>
</div>
```jsx import {HiMenuAlt2} from 'react-icons/hi'
<Button leftIcon={<HiMenuAlt2 className="mr-1 h-4 w-4" />}>Button</Button>
<Button rightIcon={<HiMenuAlt2 className="ml-1 h-4 w-4" />}>Button</Button>
``` --- ### Loading state
<div className="flex gap-2">
